...
class TestTrieContains:
    ...
    def test__contains__non_string(self) -> None:
        ...
        non_string_int = cast("object", 123)
        non_string_none = cast("object", None)
        non_string_list = cast("object", [])
...
class TestTrieEq:
    ...
    def test__eq__not_trie(self) -> None:
        """Comparison with non-trie returns False."""
        trie = Trie(["abc"])

        non_trie_int = cast("object", 123)
        non_trie_str = cast("object", "abc")
